...
const ProductsDetails = () => {
  ...
  return (
    ...
    <div class="sidebar mt-[80px] h-[600px] flex flex-col items-center w-50 overflow-hidden text-gray-400  rounded">
      ...
      <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-green-700 text-gray-200 hover:text-gray-300 bg-green-700" href="liste">
					<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div className='mt-[100px] ml-9 w-[900px] p-2'>
  {products.map((product, index) => (
    <div key={product._id} className={`p-9 mb-4 products details rounded-lg bg-white ${index !== products.length - 1 ? 'mb-4' : ''}`}>
      <h4 className='text-lg font-semibold text-green-700'>{product._id}</h4>
